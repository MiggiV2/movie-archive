...
public class SaveAuditLogAction
{
	...
	public void run(String username, AbstractAuditLogAction action, String message, MovieEntity movieEntity)
	{
		AuditLogEntity logEntity = new AuditLogEntity(username, action, message, movieEntity);
