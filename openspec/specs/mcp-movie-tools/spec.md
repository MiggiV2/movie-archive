...
The concrete MCP tools exposed by the archive — search/list/get read tools and admin-only create/update write tools — their inputs/outputs, and authorization. Tools delegate to existing actions so behavior matches the REST API.
